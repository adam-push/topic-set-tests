...
typedef enum {
        ...
        MESSAGE_TYPE_SERVICE_RESPONSE = 6,
        MESSAGE_TYPE_SERVICE_ERROR = 7,
...
typedef struct v5_message_s {
        ...
        /// This value is only valid for request messages.
        /// Response and error messages will not set this value.
